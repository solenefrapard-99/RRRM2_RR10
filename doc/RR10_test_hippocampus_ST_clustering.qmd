...
# `{r, include=FALSE} # se_brain <- InputFromTable(infotable = infoTable, #                      min.spot.feature.count = 100, #                      min.gene.count = 100,  #                      min.gene.spots = 10, #                      min.spot.count = 100, #                      platform =  "Visium") #`
