---
title: "RR10_test_hippocampus_ST_clustering"
...
visium.dir <- "/Users/solenefrapard/Documents/RRRM2_RR10_NASA_Project2/DataProcessing/RRRM2_RR10_test/RR-10/Hippocampus"
...
DimPlot(se_brain_merged_notfilt, cols = coldef, reduction = "umap")
```
...
#HOW CAN I MAKE A UMAP ??? reduction = "umap" not working because no umap in the seurat object
```
...
```{r}
#| output: false
coldef <- c("#004A55","#0000FF", "#0031D4", "#00CBD4", "#006A21", "#799400","#FFD66A", "#D4C200", "#D6E279","#D4D6FF", "#D3AAFF", "#7500BF","#AA0084", "#FF9A94", "#FF8861","#D43938", "#946E55", "#7F1100", "#9B9A9A", "#D55E00" )
